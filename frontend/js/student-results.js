...
function initializeDownload() {
    ...
    btn.addEventListener("click", function () {
        ...
        // (window.location.hostname === "localhost" ? "http://localhost:5000/api" : "https://student-mangenet-system.onrender.com/api") + "/student/download-result";
...
// fetch((window.location.hostname === "localhost" ? "http://localhost:5000/api" : "https://student-mangenet-system.onrender.com/api") + "/student/results")
